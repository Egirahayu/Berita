...
$category = query("SELECT COUNT(*) FROM category");
$categoryCount = $category[0]['COUNT(*)'];

$author = query("SELECT COUNT(DISTINCT author) FROM posts");
$authorCount = $author[0]['COUNT(DISTINCT author)'];
            ...
            <div class="row text-light text-center">
              <div class="col-lg-3 col-6">
                <div class="small-box bg-primary">
                  ...
                  <a href="posts/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                  ...
                  <a href="author/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
