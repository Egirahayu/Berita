          ...
          <div class="col-lg-8">
            <form method="post" action="" class="mb-5">
              <div class="mb-3">
                ...
                <input class="form-control" id="name_category" name="name_category" rows="5" required></input>
              </div>
              <button type="submit" class="btn btn-primary" name="add_category">Add Data!</button>
            </form>
          </div>
        </div>
      </main>
