...
$comment = query("SELECT comment.id, posts.title, name, comment, comment.date
FROM comment
JOIN posts ON comment.post_id = posts.id");
...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="../index.php">HoyNews</a>
      ...
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">HoyNews</h5>
          ...
          <div class="table-responsive col-lg-11">
            <table class="table table-bordered  table-striped table-sm">
              <thead>
                <tr>
                  <th scope="col">#</th>
                  <th scope="col" width="320px">Title</th>
                  <th scope="col">Name</th>
                  <th scope="col" width="170px">Comment</th>
              ...
              <tbody>
                <?php foreach ($comment as $coment) : ?>
                  <tr>
                    <td><?= $i; ?>.</td>
                    <td><?= $coment['title']; ?></td>
                    <td><?= ucwords($coment['name']); ?></td>
                    <td><?= $coment['comment']; ?></td>
                    <td><?= date("d F Y H:i:s", strtotime($coment['date'])); ?></td>
                    <td>
                      <a href="delete.php?id=<?= $coment['id']; ?>" class="badge bg-danger" onclick="return confirm('Hapus Data?')"><span data-feather="x-circle" style="width: 18px;"></span></a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
